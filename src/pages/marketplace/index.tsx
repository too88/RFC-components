...
import SearchComponent, {
  FieldType,
} from "~/components/molecules/filter/index.tsx";
import CardList from "~/components/molecules/card-list/index.tsx";

const Marketplace = () => {
  const [form] = Form.useForm<FieldType>();
  const { addMoreDataFn, getProductList, data, loading, isLoading } =
    useMarketplaceActions(form);
